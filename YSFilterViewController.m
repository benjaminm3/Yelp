...
- (void)viewDidLoad
{
    ...
    UINib *nib = [UINib nibWithNibName:@"YSSegmentedViewControlCell" bundle:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        YSSegmentedViewControlCell *cell = (YSSegmentedViewControlCell *)[self.filterTableView dequeueReusableCellWithIdentifier:@"SegmentedCell" forIndexPath:indexPath];
